        ...
        <>
            <div className="popup-main">
                <div className="popup-title">
                    <h2>R</h2><h2>e</h2><h2>g</h2><h2>i</h2><h2>s</h2><h2>t</h2><h2>r</h2><h2>a</h2><h2>t</h2><h2>i</h2><h2>o</h2><h2>n</h2><h2>&nbsp;</h2><h3>S</h3><h3>u</h3><h3>c</h3><h3>c</h3><h3>e</h3><h3>s</h3><h3>f</h3><h3>u</h3><h3>l</h3>
                ...
                <div className="popup-content">{"Further Details and Hall Ticket Information will be contacted through this WhatsApp Group."}</div>
				<a className="popup-button" href="https://chat.whatsapp.com/GGi0AUsuslz5eOdEarzmTa">WhatsApp</a>
            </div>
        </>
    );
}
			...
			<div className="page-container">
				...
				<form onSubmit={handleSubmit} className="cryptech-right-bar">
					<div style={{whiteSpace: "break-spaces"}}>
						{"For Any Queries Contact :\nDivyam Goel\t\t: 6283872232\nPranjal Chamaria\t: 9435623580"}
					</div>
					...
					<div style={{display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
						...
						<p style={{textAlign: "center"}}>Registration Fee: <span style={{textDecoration: "line-through"}}>₹200</span>&nbsp;₹150</p>
					</div>
					...
					<div className="cryptech-input-div">
						...
						<input className="cryptech-input" id="team" type="text" placeholder="Team Name" required/>
					</div>
					{/* Name 1 */}
					<div className="cryptech-input-div">
						<div className="cryptech-icons">
						...
						<input className="cryptech-input" id="name1" type="text" placeholder="Member 1 Name" required/>
					</div>
					{/* Email 1 */}
					<div className="cryptech-input-div">
						<div className="cryptech-icons">
						...
						<input className="cryptech-input" id="email1" type="email" placeholder="Member 1 Email ID" required/>
					</div>
					{/* Name 2 */}
					<div className="cryptech-input-div">
						<div className="cryptech-icons">
					...
					<div className="cryptech-input-div">
						...
						<input className="cryptech-input" id="txnid" type="text" placeholder="Transaction ID after Paying ₹150" required/>
					</div>
					{/* Class */}
					<div className="cryptech-input-div">
						<div className="cryptech-icons">
						...
						<select className="cryptech-input" name="class" id="class" required>
							<option selected={true} disabled={true} value="">
								Choose Class
							</option>
							<option value="9-10">IX & X</option>
					...
					<div className="cryptech-input-div">
						...
						<input className="cryptech-input" name="city" id="city" type="text" placeholder="Enter City" required/>
					</div>
